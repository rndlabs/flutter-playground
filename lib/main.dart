  ...
  runZonedGuarded<Future<void>>(() async {
    ...
    if (Platform.isAndroid) {
      const androidConfig = FlutterBackgroundAndroidConfig(
        notificationTitle: "Flutter Bees in Waku",
        notificationText: "This app is maintaining a WAKU2-RELAY connection",
      ...
      // Create an another isolate to handle the Waku connection
      await Isolate.spawn(
        backgroundIsolate,
        null,
...
class _MyHomePageState extends State<MyHomePage> {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Center(
        child: FutureBuilder(
            // All rust functions are called as Futures
